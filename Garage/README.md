...
Créer deux listes comparables de véhicules, pour supprimer les doublons, avant de créer les garages et d'enregistrer le fichier texte garage.txt
 ...
 Dans une classe GarageTest, faire une méthode main: | [GarageTest avec sa méthode main](Garage/src/fr/marcharnist/tests/GarageTest.java "Accédez à la classe GarageTest")
 Créer 5 voitures avec leurs options dans main| [Méthode main de GarageTest](Garage/src/fr/marcharnist/tests/GarageTest.java "Accédez à la classe GarageTest")
 ...
 Faire deux implémentations d'option (GPS, Climatisation) | [GPS: ligne 33 de GarageTest.java](Garage/src/fr/marcharnist/tests/GarageTest.java "Accédez à la classe GarageTest")
 Faire deux implémentations d'option (GPS, Climatisation) |[Climatisation: ligne 41 de GarageTest.java](Garage/src/fr/marcharnist/tests/GarageTest.java "Accédez à la classe GarageTest")
