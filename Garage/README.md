...
Créer deux listes comparables de véhicules, pour supprimer les doublons, avant de créer les garages et d'enregistrer le fichier texte garage.txt
 ...
 Faire une méthode qui permet de supprimer les doublons de la première liste. | [Ligne 221 et suivantes de Garage.java](https://github.com/MarcHarnist/Garage/blob/tests/Garage/src/fr/marcharnist/garage/Garage.java "Accéder au fichier")
