# To do list #
 ...
 Faire une méthode qui permet de supprimer les doublons de la première liste. | [Ligne 159 et suivantes](https://github.com/MarcHarnist/Garage/blob/tests/Garage/src/fr/marcharnist/garage/Garage.java "Accéder au fichier")
